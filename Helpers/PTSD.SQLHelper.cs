...
namespace PTSDProject
{
    /*
     * 概觀（中文說明）：
     * - 自訂 ADO.NET 輔助類別，封裝 SqlClient 常見操作（查詢、非查詢、唯讀值、DataReader、XmlReader、批次填充）。
     * - 從 appsettings.json 讀取 ConnectionStrings:PTSDContext 作為預設連線字串。
     * - 多數方法會自動建立/開啟/關閉 SqlConnection，並清空 SqlParameter 以重複使用同一個 SqlCommand。
     * - 提供多載以支援直接傳入 SqlCommand、連線字串、SqlConnection、SqlTransaction、或 Stored Procedure 名稱與參數。
     * - 預設部分指令會將 CommandTimeout 設為 0（無逾時），長時間執行可能佔用資源；如需控管請自行調整。
     * - 目前使用 System.Data.SqlClient；若要採用較新驅動，可考慮 Microsoft.Data.SqlClient。
     */
    /// <summary>
    ...
    public sealed class SqlHelper
    {
        ...
        // 從 appsettings.json 載入設定（用於取得資料庫連線字串）
        private static readonly IConfiguration config = new ConfigurationBuilder()
              .SetBasePath(Directory.GetCurrentDirectory())
              .AddJsonFile("appsettings.json", optional: true, reloadOnChange: true)
              .AddJsonFile("appsettings.Development.json", optional: true, reloadOnChange: true)
              .Build();
        // 取得 ConnectionStrings:PTSDContext，作為預設 SQL 連線字串
        ...
        //public static string SQLReplace(string ssql, string UserId, string UserGuid, string KeyParameter, string ParentParameter, string Lang )
        //{
        //    return SQLReplace(ssql, UserId, UserGuid, KeyParameter, ParentParameter, Lang, "", "", "");
        //}

        //public static string SQLReplace(string ssql, string UserId, string UserGuid, string KeyParameter, string ParentParameter, string Lang, string XMLParameter)
        //{
        //    return SQLReplace(ssql, UserId, UserGuid, KeyParameter, ParentParameter, Lang, XMLParameter, "", "");
        //}
        ...
        #region Self Define ExecuteNonQuery
        ...
        /// <returns></returns>
        // 用途：接受外部已設定好的 SqlCommand，幫忙接上連線、設定逾時並執行，結束後清理參數與關閉連線
        ...
        public static int ExecuteNonQuery(string commandText)
        {
            ...
            return ExecuteNonQuery(_connString, CommandType.Text, commandText);
        }
        ...
        /// <returns></returns>
        public static int ExecuteNonQuery(string commandText, SqlParameterCollection Parameters)
        {
            
            return ExecuteNonQuery(_connString, commandText, Parameters);
        }
        ...
        public static int ExecuteNonQuery(string commandText, CommandType commandType)
        {
            ...
            return ExecuteNonQuery(_connString, commandType, commandText);
        }
        ...
        /// <param name="Parameters"></param>
        /// <returns></returns>
        public static int ExecuteNonQuery(string connectionString, string commandText, SqlParameterCollection Parameters)
        {
        ...
        /// <param name="Parameters"></param>
        /// <returns></returns>
        public static int ExecuteNonQuery(SqlConnection connection, string commandText, SqlParameterCollection Parameters)
        {
            ...
            {
                cmd.Parameters.Add(P.ParameterName);
        ...
        public static string ExecuteString(string commandText)
        {
             
            using DataSet Ds = ExecuteDataset(_connString, CommandType.Text, commandText);
        ...
        /// <remarks>
        /// e.g.:  
        ///  DataSet ds = ExecuteDataset("Select * from Tables");
        /// </remarks>
        /// <param name="commandText">The stored procedure name or T-SQL command</param>
        ...
        // 用途：接受外部 SqlCommand，建立連線後以 SqlDataAdapter.Fill 取得查詢結果並回傳 DataSet
        ...
        public static object ExecuteScalar(string commandText)
        {
            ...
            return ExecuteScalar(_connString, CommandType.Text, commandText, (SqlParameter[])null);
        }

        /// <summary>
        /// 執行 SqlCommand 並回傳單一值 (泛型版本)，使用預設連線
        /// </summary>
        public static T ExecuteScalar<T>(SqlCommand cmd)
        {
            object result = ExecuteScalar(_connString, cmd);
            ...
            params SqlParameter[] commandParameters)
        {
            ...
            //string CertificateKey = config.GetValue<string>("AppSettings:CertificateKey");
            //string SymmetricKey = config.GetValue<string>("AppSettings:SymmetricKey");
            //command.CommandText = $"OPEN SYMMETRIC KEY {SymmetricKey} DECRYPTION BY CERTIFICATE [{CertificateKey}]; " + System.Environment.NewLine + command.CommandText + ";" + System.Environment.NewLine + " CLOSE ALL SYMMETRIC KEYS  ";
        ...
        public static void UpdateDataset(SqlCommand insertCommand, SqlCommand deleteCommand, SqlCommand updateCommand, DataSet dataSet, string tableName)
        {
            ...
            using (SqlDataAdapter dataAdapter = new SqlDataAdapter())
            {
                ...
                //string CertificateKey = config.GetValue<string>("AppSettings:CertificateKey");
                //string SymmetricKey = config.GetValue<string>("AppSettings:SymmetricKey");
                //updateCommand.CommandText = $"OPEN SYMMETRIC KEY {SymmetricKey} DECRYPTION BY CERTIFICATE [{CertificateKey}]; " + System.Environment.NewLine + updateCommand.CommandText + ";" + System.Environment.NewLine + " CLOSE ALL SYMMETRIC KEYS  ";
                //insertCommand.CommandText = $"OPEN SYMMETRIC KEY {SymmetricKey} DECRYPTION BY CERTIFICATE [{CertificateKey}]; " + System.Environment.NewLine + insertCommand.CommandText + ";" + System.Environment.NewLine + " CLOSE ALL SYMMETRIC KEYS  ";
                //deleteCommand.CommandText = $"OPEN SYMMETRIC KEY {SymmetricKey} DECRYPTION BY CERTIFICATE [{CertificateKey}]; " + System.Environment.NewLine + deleteCommand.CommandText + ";" + System.Environment.NewLine + " CLOSE ALL SYMMETRIC KEYS  ";
        ...
        //private static void CopySqlServerRowsToSQLiteDB(string sqlConnString, string sqlitePath, string commandText, string TableName)
        //{
        ...
        //        string sqliteConnString = builder.ConnectionString;
        ...
        //                try
        //                {
        //                    using (DataSet ds = ExecuteDataset(commandText))
        //                    {
        //                        SQLiteCommand insert = BuildSQLiteInsertCommand(ds.Tables[0], TableName);
        //                        int counter = 0;
        //                        while (reader.Read())
        //                        {
